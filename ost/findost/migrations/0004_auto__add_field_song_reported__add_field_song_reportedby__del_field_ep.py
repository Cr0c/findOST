...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Song.reported'
        db.add_column('findost_song', 'reported', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'Song.reportedby'
        db.add_column('findost_song', 'reportedby', self.gf('django.db.models.fields.CharField')(max_length=15, null=True), keep_default=False)

        # Deleting field 'Episode.reportedby'
        db.delete_column('findost_episode', 'reportedby')

        # Deleting field 'Episode.reported'
        db.delete_column('findost_episode', 'reported')

        # Deleting field 'Film.reportedby'
        db.delete_column('findost_film', 'reportedby')

        # Deleting field 'Film.reported'
        db.delete_column('findost_film', 'reported')


    def backwards(self, orm):
        
        # Deleting field 'Song.reported'
        db.delete_column('findost_song', 'reported')

        # Deleting field 'Song.reportedby'
        db.delete_column('findost_song', 'reportedby')
        ...
        # Adding field 'Episode.reported'
        db.add_column('findost_episode', 'reported', self.gf('django.db.models.fields.CharField')(max_length=500, null=True), keep_default=False)
        ...
        # Adding field 'Film.reported'
        db.add_column('findost_film', 'reported', self.gf('django.db.models.fields.CharField')(max_length=500, null=True), keep_default=False)
