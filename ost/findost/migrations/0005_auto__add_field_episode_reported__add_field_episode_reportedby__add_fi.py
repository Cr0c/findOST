...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('findost_episode', 'reported', self.gf('django.db.models.fields.CharField')(max_length=15, null=True), keep_default=False)

        # Adding field 'Episode.reportedby'
        db.add_column('findost_episode', 'reportedby', self.gf('django.db.models.fields.CharField')(max_length=15, null=True), keep_default=False)

        # Adding field 'Film.reported'
        db.add_column('findost_film', 'reported', self.gf('django.db.models.fields.CharField')(max_length=15, null=True), keep_default=False)

        # Adding field 'Film.reportedby'
        db.add_column('findost_film', 'reportedby', self.gf('django.db.models.fields.CharField')(max_length=15, null=True), keep_default=False)
