...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Comment.episode'
        db.alter_column('findost_comment', 'episode_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['findost.Episode'], null=True))

        # Changing field 'Comment.film'
        db.alter_column('findost_comment', 'film_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['findost.Film'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Comment.episode'
        db.alter_column('findost_comment', 'episode_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['findost.Episode']))

        # Changing field 'Comment.film'
        db.alter_column('findost_comment', 'film_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['findost.Film']))
    ...
    models = {
        ...
        'findost.comment': {
            ...
            'episode': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['findost.Episode']", 'null': 'True'}),
            'film': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['findost.Film']", 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
